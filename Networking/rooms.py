import uuid
from Networking.player import Player
...
class Rooms:
    ...
    def join(self, player_identifier, room_id=None, autojoin=False):
        """
        Add player to room
        """
        ...
        if autojoin:
            for room in self.rooms:
                if not self.rooms[room].is_full():
                    self.rooms[room].players.append(player)
                    return room
